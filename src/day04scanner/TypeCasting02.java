...
public class TypeCasting02 {
	...
	public static void main(String[] args) {
		...
		//Decimel (ondalik) sayiyi byte, short, int, long gibi bir tamsayiya assign edersek Java
		...
		//Matematiksel islemlerde birden fazla type kullanilirsa Java sonucu en buyuk data type' a göre verir. 
		double d2 = 5.0/2;
