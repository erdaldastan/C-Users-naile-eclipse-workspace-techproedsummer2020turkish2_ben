...
public class IfElseIf04 {
	...
	public static void main(String[] args) {
		/*
		 Kullanicidan iki notunu aliniz
		 Ortalama 50 nin altinda ise "Kaldiniz"
		 Ortalama 70 nin altinda ise "C ile gectiniz"
		 Ortalama 85 nin altinda ise "B ile gectiniz"
		 Ortalama 100 ve 100 un altinda ise "A ile gectiniz"
		 Diger durum"larda (negatif ve 100 den buyuk) "Gecerli not giriniz"
		 */
